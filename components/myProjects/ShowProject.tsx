...
export default function ShowProject({ image, title, link, categories, imageContWidth = "min(400px, 80vw)" }: { image: string, title: string, link: string, categories: string, imageContWidth?: string }) {
